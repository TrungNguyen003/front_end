...
import "../styles/style_navhome.css";
...
function Navigation({ children }) {
  ...
  return (
    <>
      <div className="main-container-1331">
        <div className="rectangle-5-131">
          ...
          <div className="frame-131">
            ...
            <div className="group-131 dropdown">
              ...
              {isCatsDropdownOpen && (
                <div className="dropdown-menu-1331">
                  <Link to="/category/thức ăn cho mèo">Thức ăn cho mèo</Link>
                  <Link to="/category/đồ chơi cho mèo">Đồ chơi cho mèo</Link>
                  <Link to="/category/phụ kiện cho mèo">Phụ kiện cho mèo</Link>
                </div>
              )}
            </div>
            ...
            <div className="group-8-131 dropdown">
              ...
              {isDogsDropdownOpen && (
                <div className="dropdown-menu-1331">
                  <Link to="/category/thức ăn cho chó">Thức ăn cho chó</Link>
                  <Link to="/category/đồ chơi cho chó">Đồ chơi cho chó</Link>
                  <Link to="/category/phụ kiện cho chó">Phụ kiện cho chó</Link>
                </div>
              )}
            </div>
